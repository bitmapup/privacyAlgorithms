...
def exponential_filter(kilometers, minimunSamples, epsilon):
    ...
    for i in range(8,12):
        ...
        for rating in lista_ratings:
            new_rating = rating + abs(np.random.exponential(scale=b))
...
if __name__ == "__main__":
    exponential_filter(first_arg, second_arg, third_arg)
